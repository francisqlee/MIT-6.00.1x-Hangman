...
def getAvailableLetters(lettersGuessed):
    ...
    return alphabet.join(alphabetList)
...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while mistakesMade > 0 and not isWordGuessed(secretWord, lettersGuessed):
        print("-------------\nYou have", mistakesMade, "guesses left.\n"
            "Letters Guessed:", s.join(lettersGuessed))
